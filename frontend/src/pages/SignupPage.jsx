...
const SignUpPage = () => {
	...
	return (
		<div className='flex flex-col justify-center py-50 sm:px-6 lg:px-8'>
			...
			>
				<h2 className='mt-6 text-center text-3xl font-extrabold text-[#BF360C]'>Create your account</h2>
			</motion.div>
			...
			>
				<div className='bg-[#fddfc6df] py-8 px-4 shadow sm:rounded-3xl sm:px-10'>
					<form onSubmit={handleSubmit} className='space-y-6'>
						<div>
							<label htmlFor='name' className='block text-sm font-medium text-[#BF360C]'>
								Full name
							</label>
							<div className='mt-1 relative rounded-md shadow-sm'>
								...
								<input
									...
									className='block w-full px-3 py-2 pl-10 bg-[#fddfc6df] border border-[#BF360C] rounded-md shadow-sm
									 placeholder-[#db725272] focus:outline-none focus:ring-[#db725272] focus:border-[#BF360C] sm:text-sm'
									placeholder='Minh Doan'
								/>
							</div>
						</div>
						...
						<div>
							<label htmlFor='confirmPassword' className='block text-sm font-medium text-[#BF360C]'>
								Confirm Password
							</label>
							<div className='mt-1 relative rounded-md shadow-sm'>
								<div className='absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none'>
								...
								<input
									...
									className=' block w-full px-3 py-2 pl-10 bg-[#fddfc6df] border
									 border-[#BF360C] rounded-md shadow-sm placeholder-[#db725272] focus:outline-none focus:ring-[#db725272] focus:border-[#BF360C] sm:text-sm'
									placeholder='••••••••'
								/>
							</div>
						</div>
					...
					<p className='mt-8 text-center text-sm text-[#db725272]'>
						...
						<Link to='/login' className='font-medium text-[#BF360C] hover:text-[#BF360C]'>
